...
public class OrderTaskAssembler {
    ...
    public static OrderTask readPowerReportInterval() {
        ParamsReadTask task = new ParamsReadTask();
        task.setData(ParamsReadKeyEnum.GET_POWER_REPORT_INTERVAL);
        return task;
    }
    ...
    public static OrderTask writePowerReportInterval(int interval) {
        ParamsWriteTask task = new ParamsWriteTask();
