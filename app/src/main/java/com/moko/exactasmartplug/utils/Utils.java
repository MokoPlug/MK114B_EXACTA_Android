package com.moko.exactasmartplug.utils;
...
public class Utils {
    ...
    public static File getFile(Context context, String fileName) {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            // 优先保存到SD卡中
            devicePath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "ExactaSmartPlug" + File.separator + fileName;
        } else {
            // 如果SD卡不存在，就保存到本应用的目录下
            devicePath = context.getFilesDir().getAbsolutePath() + File.separator + "ExactaSmartPlug" + File.separator + fileName;
        }
